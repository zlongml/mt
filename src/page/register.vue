  ...
  <div class="page-register">
    ...
    <div class="content">
      ...
      >
        ...
        <el-form-item>
          <el-button type="primary" @click="submitForm('registerForm')">完成注册并登录</el-button>
        </el-form-item>
        <el-form-item>
          <el-checkbox v-model="checked" v-if="checked === false">
              我已阅读并同意
              <a href="#">《美团用户协议》</a>
              <a href="#">《隐私政策》</a>
              ，并授权美团使用该美团账号信息（如昵称、头像、收货地址）进行统一管理
          </el-checkbox>
          <el-checkbox v-model="checked" v-else>
              已同意相关协议
          </el-checkbox>
          </el-form-item>
    ...
    <footer>
      <a href="#">©meituan.com</a>  京ICP证070791号  京公网安备11010502025545号
    </footer>
  </div>
</template>
<script>
